...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="/educationlist/index.css">
...
<nav class="up navbar bg-dark navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href=""><img src="/educationlist/profile.png" alt="pr"></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"> <img src="/educationlist/downloadxxs.png" alt="u"> </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><img src="/educationlist/logout.png" alt="o"></a>
      </li>
    </ul>
  </div>
</nav>
          ...
          <div class="row  justify-content-center">
            ...
            <img src="https://img.icons8.com/emoji/20/000000/star-emoji.png" />
             ...
             <div class="col-9 content column">
              ...
              <div class="row r1">
                ...
                <div class="col-6">
                  Home Tution: ${usersubservice.education.hometution}
                </div>
              </div>
                <div class="row r1">
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    Level: ${usersubservice.education.grade}
                  </div>
               </div>
               <div class="row r1">
           ...
           <div class="container c2">
                <div class="row">
                  <div class="col-3  advert">
                    <div class="row  justify-content-center">
                      <img class="image" src="/educationlist/image.jpg" alt="">
                    </div>
                    <div class="row justify-content-center">
                      ⭐⭐⭐⭐
                    </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <script type="text/javascript" src="/educationlist/index.js"></script>
  </body>
</html>
