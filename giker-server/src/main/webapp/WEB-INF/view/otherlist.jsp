...
<head>
  ...
  <link rel="stylesheet" href="/coachform/index.css">
...
<body>
  ...
  <nav class="up navbar bg-dark navbar-expand-lg navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href=""><img src="/coachform/profile.png" alt="pr"></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"> <img src="/coachform/uploadxxs.png" alt="u"> </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"><img src="/coachform/logout.png" alt="o"></a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <!-- form -->
  <form:form class="up" action="addgivercoach" method="post" modelAttribute="coachdto">
           ...
           <label class="custom-file-label" for="inputGroupFile01">choose a file</label>
               ...
               <div class="last">
                 ...
                 <div class="container link">
                     <form:input type="text" path="location" id="address" name="insta" placeholder=" enter your Address Here"/>
                   </div>
                   <div class="signbtn">
             ...
             <div class="container tnc">
               <p>By clicking the ADD button, you agree to our <a href="#">Terms & Conditions</a>  and<br> <a href="#">Privacy Policy</a>.....Congrats</p>
             </div>
      <!-- textarea con up -->
