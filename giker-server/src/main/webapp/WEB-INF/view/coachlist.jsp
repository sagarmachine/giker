...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>coach/other list</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="/coachlist/index.css">
...
<nav class="up navbar bg-dark navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href=""><img src="/coachlist/profile.png" alt="pr"></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"> <img src="/coachlist/downloadxxs.png" alt="u"> </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><img src="/coachlist/logout.png" alt="o"></a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="container c1">
  <div class="row">
          ...
          <div class="row  justify-content-center">
           ...
           <!--  <div class="container c2">
                <div class="row">
                  <div class="col-3  advert">
                    <div class="row  justify-content-center">
                      <img class="image" src="/coachlist/image.jpg" alt="">
                    </div>
                    <div class="row justify-content-center">
                      ⭐⭐⭐⭐
                    </div>
    ...
    <c:url  var="url" value="showgiverlist">
    <c:param name="subservicecode" value="${subservicecode}"></c:param>
    </c:url>
    <div class="container col-3 fix">
      <div class="roti">
     <form action="showgiverlist">
        <div class="col-3 co3">
          <button  type="submit" class="schbtn"> <img src="/coachlist/searchicon.png" alt=""> </button>
        </div>
         <div class="col-6 co4">
           <input type="text" name="search" placeholder="search by city or pincode" value="">
         </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <script type="text/javascript" src="/coachlist/index.js"></script>
  </body>
</html>
