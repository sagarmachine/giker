...
CREATE TABLE `order_review` (
  ...
  `seller_feedback` varchar(200) NOT NULL,
  `order_reviewcol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_reviewfk1_idx` (`order_id`),
  CONSTRAINT `order_reviewfk1` FOREIGN KEY (`order_id`) REFERENCES `oorder` (`order_id`)
